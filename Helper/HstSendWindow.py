...
class SendWindowItem:
    def __init__(self, state, seqnum, content):
        self.state = state  # 0表示可用，1表示已经发送但是没有确认，2表示已经确认
        self.seqnum = seqnum
        self.content = content
        self.acktime = 0  # ack次数，等于4的时候表示三次冗余
